...
public class SinglyLinkedList<E  extends Comparable<E>>
{
  ...
  public boolean checkPallindroneFunction(Node<E>slow,Node<E>fast,Node<E> temp)
  {
    if(fast==null)
    {
      temp=slow;
    ...
    boolean result=checkPallindroneFunction(slow.getNext(),fast.getNext().getNext(),temp);
    if(result==true)
    {
      if(slow.getElement()==temp.getElement())
      {
        temp=temp.getNext();
        return true;
      }
  ...
  {
    Node<E>temp=head;
    if(checkPallindroneFunction(temp,temp,null))
